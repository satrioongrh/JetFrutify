...
class RemoteRepository @Inject constructor(
                ...
                if (resp?.sTATUS == "SUCCESS") {
                    ...
                    dataStore.apply {
                        runBlocking {
                            ...
                            putBoolean(Constant.PREF_IS_LOGIN, true)
                            Log.d("nefe", "onResponse: ${dataStore.getString(Constant.PREF_USER_PHONE)}")
                        }
                    }
                } else {
                    loginResult.value =
    ...
    suspend fun getLoginData() = dataStore.getBoolean(Constant.PREF_IS_LOGIN)
